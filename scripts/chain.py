...
# Vous devez exécuter ceci en ligne de commande ou dans un environnement Jupyter Notebook
# %pip install pandas matplotlib scikit-learn tslearn prophet langchain openai langchain-core langchain-openai streamlit
